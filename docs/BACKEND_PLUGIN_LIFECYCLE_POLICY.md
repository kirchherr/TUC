...
bind to the accepted sandbox model and artifact provenance evidence, then add
resource budgets, fuzzing or negative-test evidence, and maintainer approval
before it can change `ready_to_enable_plugins`.
