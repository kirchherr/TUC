...
native plugin ABI loading blocked. The sandbox model, artifact provenance, and resource budget now exist as
data-only evidence; fuzzing or negative-test and maintainer-approval evidence
