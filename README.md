...
native plugin ABI loading blocked. The sandbox model and artifact provenance now
exist as data-only evidence; resource-budget, fuzzing or negative-test, and
