...
compile /out/proof
compile /out/io-count -DTUC_IO_FAULT=1
compile /out/io-direction -DTUC_IO_FAULT=2
compile /out/io-size -DTUC_IO_FAULT=3
compile /out/io-slot -DTUC_IO_FAULT=4
compile /out/io-early-output -DTUC_IO_FAULT=5
compile /out/io-duplicate-input -DTUC_IO_FAULT=6
compile /out/io-short-output -DTUC_IO_FAULT=7
compile /out/io-skip-output -DTUC_IO_SKIP_OUTPUT=1
compile /out/unknown-opcode -DTUC_PLAN_FAULT=1
compile /out/wrong-order -DTUC_PLAN_FAULT=2
compile /out/input-overwrite -DTUC_PLAN_FAULT=3
compile /out/missing-step -DTUC_PLAN_FAULT=4
compile /out/wrong-target -DTUC_PLAN_FAULT=5
