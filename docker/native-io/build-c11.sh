...
compile generated.c /out/io-count -DTUC_IO_FAULT=1
compile generated.c /out/io-direction -DTUC_IO_FAULT=2
compile generated.c /out/io-size -DTUC_IO_FAULT=3
compile generated.c /out/io-slot -DTUC_IO_FAULT=4
compile generated.c /out/io-early-output -DTUC_IO_FAULT=5
compile generated.c /out/io-duplicate-input -DTUC_IO_FAULT=6
compile generated.c /out/io-short-output -DTUC_IO_FAULT=7
compile generated.c /out/io-skip-output -DTUC_IO_SKIP_OUTPUT=1
compile generated.c /out/unknown-opcode -DTUC_PLAN_FAULT=1
compile generated.c /out/wrong-order -DTUC_PLAN_FAULT=2
compile generated.c /out/input-overwrite -DTUC_PLAN_FAULT=3
compile generated.c /out/missing-step -DTUC_PLAN_FAULT=4
compile generated.c /out/wrong-target -DTUC_PLAN_FAULT=5
