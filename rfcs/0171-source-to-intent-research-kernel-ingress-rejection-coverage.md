...
- records all current Diagnostics rejection IDs, including import-preamble drift,
  decorator absence, annotated signatures, decorator-call, and unsupported-decorator rejections;
